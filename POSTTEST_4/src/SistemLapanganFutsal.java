...
class SistemLapanganFutsal {
    ...
    // ArrayList bertipe superclass agar bisa menampung kedua subclass
    ...
    static void createLapangan() {
        ...
        if (tipe == 1) {
            // Buat objek LapanganIndoor (subclass)
            ...
            // Buat objek LapanganOutdoor (subclass)
    ...
    static void hitungBiayaSewa() {
        ...
        if (pakaiDiskon.equalsIgnoreCase("y")) {
            ...
            total = target.hitungTotalBiaya(jam, diskon);
            ...
            total = target.hitungTotalBiaya(jam);
