abstract class LapanganFutsal {
    ...
    public void setId(int id) {
        if (id <= 0) System.out.println("ID tidak boleh nol atau negatif.");
        else this.id = id;
    }
    ...
    public void setStatus(String status) {
        if (!status.equals("Tersedia") && !status.equals("Tidak Tersedia")) {
            System.out.println("Status tidak valid. Diset ke 'Tersedia'.");
            this.status = "Tersedia";
    ...
    public void tampilInfoDasar() {
        ...
        System.out.println("Lokasi  : " + this.lokasi + " (lantai)");
